    ...
    return <div className={bem()}>
        ...
        <nav className="navbar navbar-expand-sm navbar-light bg-light">
            <div className="container">
                <Link data-testid="link-to-main-page" className={bem('Brand', ['navbar-brand'])} to="/">Example store</Link>
                <button data-testid="burger-button" className={bem('Toggler', ['navbar-toggler'])} aria-label="Toggle navigation" onClick={toggle}>
                    <span className="navbar-toggler-icon"></span>
                </button>
                <div data-testid="navbar-nav-wrapper" className={bem('Menu', [navbarClass])}>
                    <div className="navbar-nav" data-testid="navbar-nav">
                        <NavLink data-testid="nav-link-catalog" className="nav-link" activeClassName="active" to="/catalog" onClick={hide}>Catalog</NavLink>
                        ...
                        <NavLink data-testid="nav-link-cart" className="nav-link" activeClassName="active" to="/cart" onClick={hide}>{cartLabel}</NavLink>
                    </div>
                </div>
            </div>
        </nav>
