...
describe('Страницы', () => {
    describe("В магазине должны быть страницы", () => {
        it("главная", () => {
            ...
            expect(getByTestId("container").innerHTML).toBeTruthy()
        })
        it("каталог", () => {
            const { getByTestId } = render(
